Shader "Langvv/Hypnotic_Scroll_Y_Grayscale"
{
	Properties 
	{
	...
	SubShader 
	{
		...
		float _HiPower;
			...
			void surf (Input IN, inout EditorSurfaceOutput o) {
				...
				float4 UV_Pan0=float4((IN.uv_MainTexture.xyxy).x,(IN.uv_MainTexture.xyxy).y + Multiply5.x,(IN.uv_MainTexture.xyxy).z,(IN.uv_MainTexture.xyxy).w);
